...
const ROBOTICS_EVENTS: Event[] = [
...

  {
    ...
    color: "#1DDBFF",
    description:
      "Enter the arena of chaos in **Death Race 2026**, where engineering meets **raw survival**. Build powerful racing bots capable of enduring **extreme obstacles, harsh terrains, and relentless competition**. This is not just about speed — it’s about **design, control, endurance, and innovation** in a brutal battle for dominance.",
    image: "/images/posters/death-race.webp",
    tags: ["Racing", "Combat"],
    format: "Offline",
    teamSize: "1-4",
    rules: [
      "Teams must build a **custom racing bot within specified design constraints**",
      "Bots must strictly **stay within track limits** during the race",
      "Skipping any section of the track will result in **immediate disqualification**",
      "Bots going completely off-track may be **reset or disqualified based on severity**",
      "Use of **wired connections is prohibited**",
      "**LiDAR is not allowed**, but sensors like ultrasonic and cameras are permitted",
      "Bots must follow **dimension, weight, and battery constraints**",
      "Any **misconduct or disputes with officials** may lead to disqualification",
      "The **decision of event coordinators will be final and binding**",
    ],
    eventFormat: [
      "# Round 0: Abstract Submission",
      "Teams must submit a **detailed design report (max 10 pages)**",
      "Submission includes **CAD design, components, cost, and innovation details**",
      "A **1–2 minute video showcasing bot development** is required",
      "# Round 1: Technical Inspection & Prelims",
      "Bots undergo **technical inspection and validation**",
      "Multiple races will be conducted",
      "Only **top performers from each race advance**",
      "# Round 2: Semifinals",
      "Multiple qualifying races are conducted",
      "**Top 6 teams advance** to the final stage",
      "# Round 3: Finals",
      "A **head-to-head endurance race** on a challenging track",
      "Bots must withstand **obstacles, inclines, and aggressive competition**",
      "The best-performing bot is crowned the winner",
    ],
    lastDate: "TBA",
    prelimsDate: "9–10 April 2026",
    prizePool: "₹ 35,000",
    winnerPrize: "₹12,000",
...

  {
    ...
    color: "#1DDBFF",
    description:
      "Showcase the perfect synergy between **mechanical design and human control** in this precision-driven robotics challenge. Navigate your manually controlled bot through a **complex obstacle arena**, performing **accurate pick-and-place tasks** while maintaining speed, stability, and control under pressure.",
    image: "/images/posters/control-craft.webp",
    tags: ["Manual Bot", "Mechatronics"],
    format: "Offline",
    teamSize: "4",
    rules: [
      "Each team must consist of **up to 4 members**",
      "The robot must be **manually controlled (wired or wireless)**",
      "Maximum dimensions allowed: **20cm × 20cm × 15cm** (excluding manipulator)",
      "Maximum permissible weight: **4 kg including manipulator**",
      "Use of **pre-built Lego kits or ready-made grippers is prohibited**",
      "Ready-made gear assemblies are allowed",
      "Voltage must not exceed **12V DC** during operation",
      "Bots must strictly **follow the track and arena boundaries**",
      "Only **one team member is allowed to handle/control the bot during a run**",
      "Any **misconduct or disputes will be handled by officials and their decision is final**",
    ],
    scoring: [
      "# Points Earned",
      "**Cube Placement — +30 points** per successfully placed cube",
      "**Checkpoint Crossing — +50 points** after required placements",
      "**Completion Bonus — +75 points** for finishing the track",
      "**Time Bonus — +1 point per second remaining**",
      "# Penalties",
      "**Boundary Violation — -15 points** for touching red lines",
      "**Human Intervention — -25 points** per reset/touch",
    ],
    eventFormat: [
      "# Round 1: Prelims",
      "Bots undergo **technical validation and initial runs**",
      "Participants must navigate obstacles and perform **basic pick-and-place tasks**",
      "Top teams advance based on **performance and scoring**",
      "# Round 2: Finals",
      "A more **challenging arena with dynamic obstacles and inclines**",
      "Teams must complete the track within a **10-minute time limit**",
      "Final rankings are based on **total points accumulated**",
    ],
    lastDate: "TBA",
    prelimsDate: "10–11 April 2026",
    prizePool: "₹ 10,000",
    winnerPrize: "₹5,000",
    runnersUpPrize: "₹3,000",
    secondRunnersUpPrize: "₹2,000",
    ...
    prizeDetails: [
      "# Additional Awards",
      "**On-spot special award based on bot technicalities**",
...

  {
    ...
    color: "#1DDBFF",
    description:
      "Defy gravity in **Rope Runner**, a futuristic robotics challenge where bots must **cling, crawl, and conquer a suspended rope** using innovative gripping mechanisms. With strict constraints and precision-based traversal, this event tests **engineering creativity, stability, and control under extreme conditions**.",
    image: "/images/posters/rope-runner.webp",
    tags: ["Mechatronics", "Innovation"],
    format: "Offline",
    teamSize: "4",
    rules: [
      "Bot dimensions must not exceed **20cm × 15cm × 15cm** (+5 cm allowed under penalty)",
      "Maximum weight allowed is **750 grams**",
      "Bots must remain **structurally intact throughout the run**",
      "Only **gripping and crawling mechanisms** are allowed (no wheels, propellers, or flammable systems)",
      "**Readymade bots are not allowed**",
      "Bot must **not damage or alter the rope** in any way",
      "Bot must **not touch the ground during traversal**",
      "No **external force or support** may be applied to the setup",
      "Rope position and tension must **remain unchanged**",
      "Maximum time limit per run is **5 minutes**",
      "Only **one team member may handle/control the bot**",
      "Each team gets **two attempts**, best attempt is considered",
      "Judges’ decisions are **final and binding**",
    ],
    scoring: [
      "# Scoring System",
      "**Checkpoint Crossing — +50 points** per checkpoint",
      "**Distance Bonus — +1 point per cm** beyond last checkpoint",
      "**Completion Bonus — remaining time added as points**",
      "# Final Evaluation",
      "**30% weight from Round 1**",
      "**70% weight from Round 2**",
    ],
    eventFormat: [
      "# Round 1: Time-Based Rope Traverse",
      "Bots must travel from **start to finish across a suspended rope**",
      "The track contains **5 checkpoints** to measure progress",
      "Bot must cross the **first checkpoint within 2 minutes**",
      "Maximum time limit of **5 minutes per attempt**",
      "Only **2 human interventions allowed**, restart from last checkpoint",
      "# Round 2: Advanced Challenges",
      "All teams proceed to Round 2",
      "Possible challenges include **knots, inclines, 1v1 races, and load-carrying tasks**",
      "Final rankings are based on **combined performance across both rounds**",
    ],
    lastDate: "TBA",
    prelimsDate: "10–11 April 2026",
    prizePool: "₹ 6,000",
    ...
    prizeDetails: [
      "# Additional Awards",
      "**Special award for most innovative design**",
      "**Certificates for winners and participants**",
    ],
    link: "/register/RR",
    driveLink:
